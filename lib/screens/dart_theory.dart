...
<<<<<<< HEAD
            ...
            case 'main() function in Dart':
             Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => const DartMainFunctionPage()), );
              break;
            case 'Dart - Data Types':
             Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => const DartDataTypesPage()), );
              break;
            case 'String Interpolation in Dart':
             Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => const StringInterpolationPage()), );
              break;
