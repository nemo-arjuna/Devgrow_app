...
class FlutterQuizResultWidget extends StatefulWidget {
  final int score;
  final int total;
  ...
  @override
  State<FlutterQuizResultWidget> createState() => _FlutterQuizResultWidgetState();
}

class _FlutterQuizResultWidgetState extends State<FlutterQuizResultWidget> {
