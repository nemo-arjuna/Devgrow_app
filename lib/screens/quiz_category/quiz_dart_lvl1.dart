...
class DartLevel1QuizPage extends StatefulWidget {
  const DartLevel1QuizPage({super.key});

  @override
  State<DartLevel1QuizPage> createState() => _DartLevel1QuizPageState();
}

class _DartLevel1QuizPageState extends State<DartLevel1QuizPage> {
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      showDialog(
        ...
        builder: (context) => QuizResultWidget(
          ...
          bgImage: "assets/bg_quizlvl1.jpg",
          onRetry: () {
        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/bg_quizlvl1.jpg"),
              fit: BoxFit.cover,
            ),
          ),
          child: Center(
